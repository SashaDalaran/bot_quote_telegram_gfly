...
async def help_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "Примеры:\n"
        "• <code>/timer 10s чай</code>\n"
        "• <code>/timer 5m</code>\n"
        "• <code>/timer 1h20m Boss pull</code>\n\n"

        "/timerdate — таймер на конкретную дату\n"
        "Формат:\n"
        "<code>/timerdate DD.MM.YYYY HH:MM +TZ текст [--pin]</code>\n\n"
        "Примеры:\n"
        "• <code>/timerdate 31.12.2025 23:59 +3 Новый год 🎆</code>\n"
        "• <code>/timerdate 31.12.2025 23:59 +3 Новый год 🎆 --pin</code>\n\n"

        "📌 <b>Опция</b>\n"
        "<code>--pin</code> — закрепить сообщение таймера в чате\n\n"
